...
are left as NULL as stated. Create empty list as in the following
example:

CellList emptyCell = createConsCellNode("()");
***************************************************************/
...
---------------------------
The function that free the allocated cells in the given list.
****************************************************************/
